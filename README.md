...
```
$ cd
$ git clone https://github.com/jjayun/.tmux.git
...
```
$ git clone https://github.com/jjayun/.tmux.git /path/to/oh-my-tmux
...
[my own Vim configuration]: https://github.com/jjayun/.vim.git
